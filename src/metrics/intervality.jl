...
"""
function swap_matrix_rows_cols!(A::AbstractMatrix{Bool}, i::Int, j::Int)
    # Check bounds
...
"""
function calculate_gaps(A::AbstractMatrix{Bool})
    S = size(A, 1)
    total_gaps = 0
...
"""
function intervality(A_initial::AbstractMatrix{Bool}; 
                                  T_initial=10.0, 
